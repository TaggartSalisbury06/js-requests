...
// CODE HERE
function helloButtonColor() {
    sayHelloButton.style.backgroundColor = 'black'
    sayHelloButton.style.color = 'white'
}

sayHelloButton.addEventListener('mouseover', helloButtonColor)
// PROBLEM 3
/*
...
// CODE HERE
function helloButtonColorOff() {
    sayHelloButton.style.backgroundColor = '#EFEFEF'
    sayHelloButton.style.color = 'black'
}

sayHelloButton.addEventListener('mouseout', helloButtonColorOff)
...
const ohMy = () => {
    ...
    }).catch((err) => console.log({err, message: 'Error getting ohMy'}))
}
...
const repeatMyParam = () => {
    ...
    axios.get(`${baseURL}/repeat/repeat`).then(res => {
        console.log(res.data)
        repeatTxt.textContent = res.data
        repeatTxt.style.display = 'block'
    }).catch(err => console.log({err, message: 'counld not get function'}))
...
// CODE HERE
function getQuery() {
    axios.get(`${baseURL}/query-test/?name=taggart age=2`).then((res) => {
        console.log(res.data)
